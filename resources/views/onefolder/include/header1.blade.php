    ...
    <img src = "https://mir-s3-cdn-cf.behance.net/projects/404/a07b33114604795.Y3JvcCw4MDgsNjMyLDAsMA.png" width="150px",height="150px" alt = "site icon">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active ,btn btn-dark" aria-current="page" href="{{route('s_returninfo')}}">Return</a>
          </li>

          <li class="nav-item">
            <a class="nav-link active ,btn btn-dark" aria-current="page" href="{{route('userchoice')}}">order list</a>
          </li>

          <li class="nav-item">
            <a class="nav-link active ,btn btn-dark" aria-current="page" href="{{route('fine')}}">Fine</a>
          </li>
